...
export default class Index extends Taro.Component {
  ...
  render () {
    ...
    const tabList2 = [{ title: '待办事项', image: 'https://longbolife-frontend.oss-cn-hangzhou.aliyuncs.com/weapp/icon_seal_no_2019521.png', selectedImage: 'https://longbolife-frontend.oss-cn-hangzhou.aliyuncs.com/weapp/icon_seal_yes_2019521.png', text: 'new' }, { title: '拍照', iconType: 'camera' }, { title: '文件夹', iconType: 'folder', text: '100', max: '99' }]
    const tabList3 = [
