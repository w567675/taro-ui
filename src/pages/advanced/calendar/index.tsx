        ...
        <View className='doc-body'>
          <View className='panel'>
            ...
            <View className='panel__content'>
              <AtCalendar onSelectDate={this.handleSelectDate} onMonthChange={this.handleMonthChange} currentDate={currentDate} marks={mark} hideTime={hideTime} time="06:30"  renderExtra={<View>343434</View>} />
            </View>
